...
import com.wl.workutils.adapters.MyFragmentPagerAdapter;
import com.wl.workutils.desgin.behavior.AppBarLayoutOverScrollViewBehavior;
import com.wl.workutils.desgin.behavior.CircleImageView;
import com.wl.workutils.desgin.behavior.CommonTabLayout;
import com.wl.workutils.desgin.behavior.NoScrollViewPager;
import com.wl.workutils.desgin.behavior.RoundProgressBar;
import com.wl.workutils.fragments.ItemFragment1;
import com.wl.workutils.model.entity.CustomTabEntity;
import com.wl.workutils.model.entity.OnTabSelectListener;
import com.wl.workutils.model.entity.TabEntity;
...
//        initTab();
        ...
        mAppBarLayout.addOnOffsetChangedListener(new AppBarLayout.OnOffsetChangedListener() {
            ...
            public void onOffsetChanged(AppBarLayout appBarLayout, int verticalOffset) {
                ...
                if (titleCenterLayout != null && mAvater != null && mSettingIv != null && mMsgIv != null) {
                    ...
                    StatusBarUtil.setTranslucentForImageView(BehaviorActivity.this, (int) (255f * percent), null);
                    if (percent == 0) {
                        groupChange(1f, 1);
                    } else if (percent == 1) {
    ...
    private void initStatus() {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT) {//4.4以下不支持状态栏变色
            ...
            StatusBarUtil.setTransparentForImageView(BehaviorActivity.this, null);
            ...
            int statusBarHeight = getStatusBarHeight(BehaviorActivity.this);
