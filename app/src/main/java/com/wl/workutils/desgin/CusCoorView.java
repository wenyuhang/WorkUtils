...
/**
 * create by wyh on 2019/6/24
 */

public class CusCoorView extends CoordinatorLayout implements View.OnTouchListener{
    ...
    public CusCoorView(@NonNull Context context) {
        super(context);
    }

    public CusCoorView(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }

    public CusCoorView(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
